...
public class ColumnHeaderPressPopup extends PopupMenu implements PopupMenu
        .OnMenuItemClickListener {
    private static final String LOG_TAG = ColumnHeaderPressPopup.class.getSimpleName();
    ...
    public ColumnHeaderPressPopup(ColumnHeaderViewHolder p_iViewHolder, ITableView
            p_jTableView) {
