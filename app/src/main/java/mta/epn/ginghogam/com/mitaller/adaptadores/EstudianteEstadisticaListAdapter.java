...
import mta.epn.ginghogam.com.mitaller.activities.EleccionEstudianteEstadisticaActivity;
import mta.epn.ginghogam.com.mitaller.entidades.Estudiante;
import mta.epn.ginghogam.com.mitaller.listener.RecyclerItemClickListener;

public class EstudianteEstadisticaListAdapter extends RecyclerView.Adapter<EstudianteEstadisticaListAdapter.ContactHolder> implements View.OnClickListener {

    private List<Estudiante> estudianteList;
    private Context context;
    EleccionEstudianteEstadisticaActivity estudianteEstadisticaActivity;

    private RecyclerItemClickListener recyclerItemClickListener;
    protected View.OnClickListener onClickListener;

    public EstudianteEstadisticaListAdapter(Context context) {
        this.context = context;
        this.estudianteList = new ArrayList<>();
        estudianteEstadisticaActivity = (EleccionEstudianteEstadisticaActivity) context;
    }
